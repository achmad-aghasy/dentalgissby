...
var style_PrevalensiKeluhanBermasalahGigidanMulut_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("SDS");
    var labelText = "";
    size = 0;
    ...
    if (value >= 2.000000 && value <= 4.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.000000 && value <= 5.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.333333 && value <= 6.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.500000 && value <= 8.000000) {
            style = [ new ol.style.Style({
